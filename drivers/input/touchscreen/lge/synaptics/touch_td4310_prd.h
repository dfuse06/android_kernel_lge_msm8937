...
enum normal_spec {
        ...
        LPWG_RAW_DATA_MAX       = 3450,
        LPWG_RAW_DATA_MIN       = 1600,
...
enum mfts_folder_spec {
        ...
        LPWG_RAW_DATA_MAX_MFTS_FOLDER  = 3425,
        LPWG_RAW_DATA_MIN_MFTS_FOLDER  = 1650,
...
enum mfts_flat_spec {
	RAW_DATA_MAX_MFTS_FLAT       = 3400,
        ...
        LPWG_RAW_DATA_MAX_MFTS_FLAT  = 3400,
        LPWG_RAW_DATA_MIN_MFTS_FLAT  = 1700,
