...
/* TD4310 Functions */
#define TD4310_FUNC_01		(u8)(1 << 0)
#define TD4310_FUNC_12		(u8)(1 << 1)
#define TD4310_FUNC_34		(u8)(1 << 2)
#define TD4310_FUNC_35		(u8)(1 << 3)
#define TD4310_FUNC_51		(u8)(1 << 4)
#define TD4310_FUNC_54		(u8)(1 << 5)
#define TD4310_FUNC_55		(u8)(1 << 6)
#define TD4310_FUNC_DC		(u8)(1 << 7)
...
struct td4310_data {
	...
	u8 td4310_function_bits;/* Needs to changed from u8 to u16 if more then 8 functions*/
